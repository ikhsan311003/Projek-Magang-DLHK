...
import cardImage3 from '../assets/D3.png';
import cardImage1 from '../assets/D1.png';
import cardImage2 from '../assets/D2.png';
import cardImage4 from '../assets/D4.png';
import cardImage5 from '../assets/D5.png';
import cardImage6 from '../assets/D6.png';
import cardImage7 from '../assets/D7.png';
import cardImage8 from '../assets/D8.png';
import cardImage9 from '../assets/D9.png';
import cardImage10 from '../assets/D10.png';
import cardImage11 from '../assets/D11.png';
import cardImage12 from '../assets/D12.png';
...
function Kehutanan() {
  ...
  const cards = [
    { img: cardImage1, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/202-jumlah-izin-untuk-hak-pengusahaan-kehutanan', title: 'Jumlah Izin Untuk Hak Pengusahaan Kehutanan' },
    { img: cardImage2, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/203-kehutanan', title: 'Kehutanan' },
    { img: cardImage3, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/206-kawasan-hutan-luasan', title: 'Kawasan Hutan (Luasan)' },
    { img: cardImage4, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/207-jumlah-polisi-hutan', title: 'Jumlah Polisi Hutan' },
    { img: cardImage5, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/209-volume-kayu-yang-dicuri', title: 'Volume Kayu yang Dicuri' },
    { img: cardImage6, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/305-luas-lahan', title: 'Luas Lahan' },
    { img: cardImage7, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/306-pelestarian-lingkungan-hidup', title: 'Pelestarian Lingkungan Hidup' },
    { img: cardImage8, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/605-data-kinerja-dinas-lingkungan-hidup-dan-kehutanan', title: 'Data Kinerja Dinas Lingkungan Hidup dan Kehutanan' },
    { img: cardImage9, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/763-data-ikk-dan-spm-urusan-kehutanan', title: 'Data IKK dan SPM Urusan Kehutanan' },
    { img: cardImage10, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/821-kerusakan-hutan', title: 'Kerusakan Hutan' },
    { img: cardImage11, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/822-luas-dan-penyebaran-lahan-kritis-di-diy', title: 'Luas dan Penyebaran Lahan Kritis di DIY' },
    { img: cardImage12, url: 'https://bapperida.jogjaprov.go.id/dataku/data_dasar/index/870-data-e-walidata-sipd-ri-urusan-kehutanan', title: 'Data E-Walidata SIPD RI Urusan Kehutanan' },
  ];
